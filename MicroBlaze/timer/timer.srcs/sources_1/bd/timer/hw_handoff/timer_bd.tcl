...
################################################################
# This is a generated script based on design: timer
#
...
proc create_root_design { parentCell } {
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net PmodALS_0_Pmod_out [get_bd_intf_ports jc] [get_bd_intf_pins PmodALS_0/Pmod_out]
  ...
  connect_bd_intf_net -intf_net axi_gpio_2_GPIO2 [get_bd_intf_ports led_16bits] [get_bd_intf_pins axi_gpio_2/GPIO2]
  ...
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M03_AXI [get_bd_intf_pins PmodALS_0/AXI_LITE_SPI] [get_bd_intf_pins microblaze_0_axi_periph/M03_AXI]
  ...
  assign_bd_address -offset 0x44A20000 -range 0x00010000 -target_address_space [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs PmodOLEDrgb_0/AXI_LITE_GPIO/AXI_LITE_GPIO_reg] -force
  assign_bd_address -offset 0x44A30000 -range 0x00010000 -target_address_space [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs PmodOLEDrgb_0/AXI_LITE_SPI/AXI_LITE_SPI_reg] -force
